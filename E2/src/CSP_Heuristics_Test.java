...
public class CSP_Heuristics_Test {
    ...
    @Test
    void testBinary() {
        for (var bEnum : new BinaryEnum[]{BinaryEnum.B2x2, BinaryEnum.B4x4, BinaryEnum.B6x6, BinaryEnum.B8x8, BinaryEnum.B10x10}) {
...
//            System.out.println("----------------------------------------------------------------");
    ...
    void testFutoshiki6x6() {
        futoshikiProblem = new Futoshiki_Problem(FutoshikiEnum.F7x7);
//        System.out.println(futoshikiProblem);
        ...
        System.out.println(resultsInOrder.get(0));
